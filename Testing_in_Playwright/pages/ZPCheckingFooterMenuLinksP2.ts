...
export class ZPCheckingFooterMenuLinksP2 {
  ...
  /** Проверка всех пунктов меню блока Footer с переходом по внутренним ссылкам */
  async checkFooterMenuItemsP2() {
    // Селектор ul меню
    const menuItems = this.page.locator('ul#menu-1-d530c0a > li'); // ID ul меню с сайта
